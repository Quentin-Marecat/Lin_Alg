SUBROUTINE INV_JAC(DIM,MATRIX,INVMATRIX,CHECK)
    ! ------------------------------------------------------------------------------------------------------------------ !
    ! --- THIS SUBROUTINE INVERSE THE MATRIX USING SOLUTION SUCCESIV LINEAR EQUATION SOLUTION WITH JACOBI ITERATION  ------------- !
    ...
    DO I = 1,DIM
        ...
        VEC = 0
        VEC(I) = 1
        CALL GAUSS_JACOBI(DIM,MATRIX,VEC,SOL,.FALSE.)
        DO J = 1,DIM
            INVMATRIX(J,I) = SOL(J)
        ENDDO
    ENDDO
